  ...
  return (
    ...
    <footer className="bg-gray-900 text-gray-300 px-6 py-10 w-screen">
        ...
        <div className="flex flex-col justify-center items-center">
          <LogoComponent className="text-2xl font-bold text-white"></LogoComponent>
          <p className="mt-1 text-2xl text-gray-400 font-bold">
      ...
      <div className="max-w-7xl mx-auto flex text-center md:text-left justify-center items-center mt-10 h-full">
        ...
        {/* Quick Links */}
        <div className="w-1/2 text-center border-dashed border-t-0 border-l-0 border-b-0 border-r-2 ">
