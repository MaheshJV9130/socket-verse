...
import { FaRocket, FaUserFriends, FaLock, FaCode, FaGlobe } from "react-icons/fa";
...
const features = [
  {
    ...
    description: "Send and receive messages instantly with powerful Socket.IO integration.",
  },
  {
  ...
  },
  {
    icon: <FaLock size={28} />,
    title: "Secure Login",
    description: "Google-authenticated login using NextAuth for security and ease.",
  },
  {
    icon: <FaCode size={28} />,
    ...
    <section className="relative w-full h-screen bg-gray-900 overflow-hidden">
      ...
      <div className="text-center max-w-4xl mx-auto flex justify-center items-center flex-col mt-10">
        ...
        <p className="text-gray-200 text-xl font-semibold mt-2">
          Discover the future of real-time communication — fast, secure, and beautifully designed.
        </p>
      </div>
      ...
      <div className="mt-5 text-center">
        <p className="text-lg mb-4">Ready to join the universe of chats?</p>
         <Link
            href="/get-started"
